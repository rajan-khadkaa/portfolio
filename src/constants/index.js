...
const webProjects = [
  ...
  // {
  //   title: "AuthNext",
  //   logo: "/images/project-logo/authnext.svg",
  //   description:
...
const mobProjects = [
  {
    title: "Medsync",
    logo: "/images/project-logo/medsync.svg",
    description:
  ...
  {
    title: "Paydrift (In progress)",
    logo: "/images/project-logo/paydrift.svg",
    description:
  ...
  //   logo: "/images/project-logo/genflick.svg",
  //   description:
...
const designProjects = [
  {
    title: "SafeTrack",
    logo: "/images/project-logo/safetrack.svg",
    description:
  ...
  {
    title: "HRMS",
    logo: "/images/project-logo/hrms.svg",
    description:
  ...
  // {
  //   title: "Donate Red",
  //   logo: "/images/project-logo/donatered.svg",
  //   description:
